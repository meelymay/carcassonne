...
CLOISTER_ROAD = Tile('cloister_road', [(CLOISTER, [C]),
                                       ...
                                       (ROAD, [S])])
CASTLE4 = Tile('CASTLE4', [(CASTLE, ALL_SIDES + [C])])
CASTLE3 = Tile('CASTLE3', [(CASTLE, reduce(lambda x, y: x+y, [FULL_SIDE[dir] for dir in [W, N, E]]) + [C]),
                           (FARM, FULL_SIDE[S])])
CASTLE3_ROAD = Tile('CASTLE3_ROAD', [(CASTLE, reduce(lambda x, y: x+y, [FULL_SIDE[dir] for dir in [W, N, E]]) + [C]),
                                     (ROAD, [S]),
                                     (FARM, [SSW]),
                                     (FARM, [SSE])])
CASTLE2 = Tile('CASTLE2', [(FARM, FULL_SIDE[N] + FULL_SIDE[E]),
                           (CASTLE, [C] + FULL_SIDE[S] + FULL_SIDE[W])])
CASTLE2_ROAD = Tile('CASTLE2_ROAD', [(FARM, [ENE, SSW]),
                                     (FARM, [SSE, ESE]),
                                     (CASTLE, FULL_SIDE[W] + FULL_SIDE[N]),
                                     (ROAD, [E, S, C])])
CASTLE_FARM2 = Tile('CASTLE_FARM2', [(CASTLE, FULL_SIDE[W] + FULL_SIDE[E] + [C]),
                                     (FARM, FULL_SIDE[N]),
                                     (FARM, FULL_SIDE[S])])
FARM_CASTLE2 = Tile('FARM_CASTLE2', [(FARM, FULL_SIDE[E] + FULL_SIDE[W] + [C]),
                                     (CASTLE, FULL_SIDE[N]),
                                     (CASTLE, FULL_SIDE[S])])
BUTT = Tile('BUTT', [(FARM, FULL_SIDE[S] + FULL_SIDE[E] + [C]),
                     (CASTLE, FULL_SIDE[W]),
                     (CASTLE, FULL_SIDE[N])])
CASTLE_END = Tile('CASTLE_END', [(FARM, reduce(lambda x, y: x+y, [FULL_SIDE[dir] for dir in [W, S, E]]) + [C]),
                                 (CASTLE, FULL_SIDE[N])])
...
CASTLE_END_ROAD_R = Tile('CASTLE_END_ROAD_R', [(FARM, FULL_SIDE[W] + [ENE, SSW]),
                                               ...
                                               (ROAD, [E, S, C]),
                                               (FARM, [SSE, ESE])])
CASTLE_END_ROAD3 = Tile('CASTLE_END_ROAD3', [(FARM, [WSW, SSW]),
                                             (FARM, [ESE, SSE]),
                                             (FARM, [ENE, WNW]),
                                             (CASTLE, FULL_SIDE[N]),
                                             (FARM, [C]),
